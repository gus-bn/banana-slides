 ...
 * Supported formats: ![alt](url) or ![](url)
 */
...
/**
 * Image Preview List Component - Horizontal Scroll
 * Parse and display all markdown images in the editor
 */
export const ImagePreviewList: React.FC<ImagePreviewListProps> = ({
  ...
  // If no images, do not render component
  if (images.length === 0) {
    return null;
  }
